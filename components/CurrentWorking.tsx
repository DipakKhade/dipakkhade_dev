...
import WhatimLearning from "./What-im-learning";

export default function CurrentWorking() {
  return (
    <>
      <div className=" md:flex justify-between pr-12">
        <div className="h-full w-full max-w-[32rem] items-center justify-center overflow-hidden pt-8 pl-12">
          ...
          <BoxReveal boxColor={"#5046e6"} duration={0.5}>
            <div className="mt-[1.5rem]">
              <p>
                -&gt; A open source Project for learning . <br />
                -&gt; a Automation tool for engineering company located at Pune
                <br />
